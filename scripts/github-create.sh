...
echo "Will create a new *$PRIVACYWORD* repo named engine-php56"
echo "on github.com in:"
echo "    user account: admindaspanel"
echo "    organization: daspanel"
echo "with this description:"
echo Docker image for HTTP engine to serve php sites using PHP 5.6
echo ""
...
curl -u admindaspanel https://api.github.com/orgs/daspanel/repos -d \
    "{\"name\": \"engine-php56\", \"description\": \"Docker image for HTTP engine to serve php sites using PHP 5.6\", \"private\": $PRIVATE_TF}"
